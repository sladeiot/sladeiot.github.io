...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('#container01', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#container01 > .wrapper > .inner', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#container09', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#container09 > .wrapper > .inner', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, replay: false });
